...
M586 P2 S1           ; Enable Telnet protocol
...
M569 P0.0 S0               ; Drive 0 | Tool axis
M906 Z{0.7*sqrt(2)*1680}   ; 70% of 1680mA RMS
M906 W{0.85*sqrt(2)*1400}  ; 85% of 1400mA rated current for LDO-42STH25-1404MAC
M906 V{0.85*sqrt(2)*1000}  ; Tool, E Series Nema 17 1000mA RMS
...
M350 X1 Y1 Z1 U1 V1 W1  ; Disable microstepping to simplify calculations
...
M92 W{(360/0.9)*(18/20)}  ; LDO-42STH25-1404MAC 0.9 step for powder tube with 18:20 gear ratio = 360 steps/revolution
M92 V{360/1.8/2}  ; direct drive to 2mm leadscrew for tool axis, 1.8 deg stepper / lead (2mm) = 100 steps/mm

; Enable microstepping all step per unit will be multiplied by the new step def
M350 X16 Y16 M16 I1        ; 16x microstepping for CoreXY axes, manipulator. Use interpolation.
M350 U4 I1                 ; 4x for toolchanger lock. Use interpolation.
M350 V16 I1                ; 16x microstepping for toolhead axis. Use interpolation.
M350 W16 I1                ; 16x microstepping for scale axis. Use interpolation.
...
M201 E1000                              ; Extruder
M201 V200                               ; Manipulator
M201 W50                                ; Scale, deg/s^2

M203 X18000 Y18000 Z800 U9000 V2500     ; Maximum axis speeds (mm/min)
...
M574 V1 S1 P"^io5.in"    ; Manipulator
...
M208 X-13.75:313.75 Y-45:341 Z0:150 V0:67
...
; 9/25/2025: This section can *PROBABLY* be removed, leaving for now in case problems arise

; Define tamper tool
; D2 = tool number 2, P2 = driver number 2
; M563 P2 D2 H2 F2
