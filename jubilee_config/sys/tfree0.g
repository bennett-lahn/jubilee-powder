...
G1 X10.0 F3000                ; Move to the pickup position with tool-0. Follow dog-leg pattern to avoid trickler.
G1 Y260.0 F3000

; G53 G0 X10.0 Y260.0 F300   ; Ready point, kept for reference
